...
trex.plot <- data.frame(x = tsne.data[, 1], y = tsne.data[, 2], col = test.round)
...
dbscan_plot <- 
  ggplot(data.frame(x = track.data$tSNE1, y = track.data$tSNE2, col = as.factor(track.data$cluster))) + 
  coord_fixed(ratio = graphical.ratio) + 

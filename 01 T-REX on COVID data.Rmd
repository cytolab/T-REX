...
setwd(paste0(getwd(), "/", output_location, output_dir))
...
write.csv(cluster.data, paste0(output_location, output_dir, strftime(Sys.time(),"%Y-%m-%d_%H_%M"), "_DBSCAN_cluster_percentiles_counts_MEM.csv"))
print(cluster.data)
```
...
new.filename = paste0(output_location, output_dir, strftime(Sys.time(),"%Y-%m-%d_%H_%M"), "_", newname, "_TREX.fcs")
# needs testing ^ 
